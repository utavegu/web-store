...
const fortune = (ctx, body = null, status = 200) => {
    ...
    // Не забудь потом обратно закомментировать строчку выше и нормальный код сделать
    const delay = 0;
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            ...
            //     return;
            // }
            // Не забудь потом обратно закомментировать строчки выше и нормальный код сделать
