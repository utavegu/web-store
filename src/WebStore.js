...
(!!!) Перечитать про Роуты - слайды и лекцию (!!!)

- Короче те компоненты, что без подкатегорий - высовывай наружу, а тем, что с категориями - одну папку на всех
- Данные призывать прямо в каталог, скорее всего, без контекста-провайдера

А дальше уже начались сложные задачи... давай решать их по одной:
1) Подгружать только нужную категорию при выборе категории (http://localhost:7070/api/items?categoryId=X)
2) Реализовать поиск
3) Заказ отдельного товара. Сначала по кнопке заказать, далее действия в корзине
